...
#ifdef PRO
#if (PRO_BASE_1M == 0)
#define INIMEMSIZE 	001000000			/* 256K */
#else
#define INIMEMSIZE 	004000000			/* 1M */
#endif
#else
...
#ifdef PRO
/* The 350's F11 does not implement the 3 LSBs */
#define MMR3_RW		070				/* read/write bits */
#else
...
#define PDR_WE		0000004				/* XXX write-enable ACF */
